    ...
    <div className="container max-w-3xl">
      ...
      <div className="prose prose-neutral max-w-none text-foreground/80 font-light leading-relaxed space-y-6">
        ...
        <ol className="list-decimal pl-6 space-y-2">
          ...
          <li>O escríbenos a <a href="mailto:hola@clicktuboda.com" className="text-primary hover:underline">hola@clicktuboda.com</a> y gestionaremos el reembolso por ti.</li>
        </ol>
        ...
        <p>Para cualquier pregunta sobre reembolsos, escríbenos a <a href="mailto:hola@clicktuboda.com" className="text-primary hover:underline">hola@clicktuboda.com</a>.</p>
      </div>
    </div>
  </div>
);
