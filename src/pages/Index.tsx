...
const Index = () => {
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-foreground/20 via-foreground/45 to-foreground/75" />
        ...
        <div className="container max-w-4xl px-5 sm:px-8">
          <RevealSection>
            ...
            <div className="text-center mt-7">
              ...
              <p className="text-xs text-muted-foreground mt-2">Desde 30€ pago único · Sin suscripciones · 30 días de garantía ·{" "}
        ...
        <div className="container max-w-4xl px-5 sm:px-8">
          <RevealSection>
            <p className="text-center text-sm font-medium text-foreground mb-6">
              ¿Por qué una web de boda en lugar de invitaciones en papel?{" "}
              <Link to="/blog/invitaciones-digitales-vs-papel" onClick={() => track("clic_blog_post", { slug: "invitaciones-digitales-vs-papel" })} className="text-primary underline underline-offset-2 hover:opacity-80 transition-opacity font-normal">
                Lee la guía →
              </Link>
            </p>
          ...
          <RevealSection>
            ...
            <div className="text-center mt-6">
              ...
              <p className="text-xs text-muted-foreground mt-3">
                <Link to="/blog/pagina-web-para-boda" className="underline underline-offset-2 hover:text-foreground transition-colors">¿Qué es una web de boda y para qué sirve?</Link>
                {" · "}
                <Link to="/blog/rsvp-boda-online-como-funciona" className="underline underline-offset-2 hover:text-foreground transition-colors">Cómo funciona el RSVP online</Link>
              </p>
            </div>
          </RevealSection>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-background">
        <div className="container max-w-3xl px-5 sm:px-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            {([
              { q: "¿Es un pago único o una suscripción?", a: <>Pago único. Pagas una sola vez y tu web de boda es tuya para siempre. Sin renovaciones ni cargos ocultos. Nunca. <Link to="/blog/web-boda-gratis-vs-pago" className="underline underline-offset-2 hover:text-foreground transition-colors">Compara opciones aquí →</Link></> },
              { q: "¿Puedo crear y editar mi boda antes de pagar?", a: <>Sí, totalmente gratis. Regístrate, personaliza tu boda y mírala en preview. Solo pagas cuando quieras publicarla. <Link to="/blog/como-crear-web-de-boda-online" className="underline underline-offset-2 hover:text-foreground transition-colors">Guía paso a paso →</Link></> },
              { q: "¿Mis invitados necesitan registrarse o instalar algo?", a: <>No. Tus invitados acceden directamente con el enlace o código QR. Sin cuenta, sin app, sin descarga. Funciona en cualquier móvil. <Link to="/blog/invitaciones-digitales-vs-papel" className="underline underline-offset-2 hover:text-foreground transition-colors">Digital vs papel →</Link></> },
      ...
      {/* Guías SEO — enlaces internos */}
      <section className="py-14 sm:py-20 bg-card border-y border-border">
        <div className="container max-w-5xl px-5 sm:px-8">
          <RevealSection>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-8">
              <div>
                <span className="inline-block text-xs uppercase tracking-[0.3em] text-primary mb-1.5 font-medium">Recursos gratuitos</span>
                <h2 className="font-heading text-2xl sm:text-3xl text-foreground">Guías para organizar tu boda</h2>
              </div>
              <Link to="/blog" onClick={() => track("clic_blog", { location: "guias_strip" })} className="text-sm text-primary hover:text-primary/80 underline underline-offset-4 shrink-0 transition-colors">
                Ver todas las guías →
              </Link>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {[
                { href: "/blog/como-crear-web-de-boda-online", title: "Cómo crear una web de boda online", desc: "Guía completa paso a paso para tener tu página lista en minutos." },
                { href: "/blog/rsvp-digital-boda-confirmacion-asistencia", title: "RSVP digital: sin WhatsApp ni llamadas", desc: "Todo lo que necesitas saber sobre confirmaciones online para tu boda." },
                { href: "/blog/plan-de-mesas-boda-consejos", title: "Plan de mesas: consejos y trucos", desc: "Cómo organizar el seating plan de tu boda sin volverse loco." },
                { href: "/blog/checklist-boda-completo", title: "Checklist de boda completo 2026", desc: "Las tareas que no puedes olvidar antes del gran día." },
                { href: "/blog/playlist-boda-canciones-imprescindibles", title: "Playlist de boda: canciones imprescindibles", desc: "Las mejores canciones para ceremonia, cóctel y fiesta." },
                { href: "/blog/presupuesto-boda-espana-cuanto-cuesta", title: "¿Cuánto cuesta una boda en España?", desc: "Presupuesto medio y cómo ahorrar sin renunciar a nada." },
              ].map((post, i) => (
                <RevealSection key={post.href} delay={i * 60}>
                  <Link
                    to={post.href}
                    onClick={() => track("clic_blog_post", { slug: post.href })}
                    className="group bg-background border border-border rounded-xl p-5 hover:shadow-md hover:border-primary/25 hover:-translate-y-1 transition-all duration-300 block"
                  >
                    <h3 className="font-heading text-sm sm:text-base text-foreground mb-1.5 group-hover:text-primary transition-colors duration-200 leading-snug">{post.title}</h3>
                    <p className="text-xs text-muted-foreground font-light leading-relaxed mb-3">{post.desc}</p>
                    <span className="text-xs text-primary inline-flex items-center gap-1 group-hover:gap-2 transition-all duration-200 font-medium">
