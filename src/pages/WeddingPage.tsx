...
const themeStyles: Record<string, Record<string, string>> = {
  elegant: { "--background": "36 33% 97%", "--foreground": "30 25% 15%", "--card": "36 30% 95%", "--card-foreground": "30 25% 15%", "--primary": "33 30% 40%", "--primary-foreground": "36 33% 97%", "--secondary": "34 25% 90%", "--secondary-foreground": "30 25% 20%", "--muted": "34 20% 92%", "--muted-foreground": "30 10% 50%", "--border": "34 20% 85%", "--accent": "36 40% 55%" },
  romantic: { "--background": "340 30% 97%", "--foreground": "340 20% 15%", "--card": "340 25% 95%", "--card-foreground": "340 20% 15%", "--primary": "340 45% 55%", "--primary-foreground": "0 0% 100%", "--secondary": "340 20% 90%", "--secondary-foreground": "340 20% 20%", "--muted": "340 15% 92%", "--muted-foreground": "340 10% 50%", "--border": "340 15% 85%", "--accent": "340 35% 65%" },
  rustic: { "--background": "25 30% 94%", "--foreground": "25 35% 12%", "--card": "25 25% 90%", "--card-foreground": "25 35% 12%", "--primary": "25 50% 32%", "--primary-foreground": "36 33% 97%", "--secondary": "25 20% 85%", "--secondary-foreground": "25 35% 15%", "--muted": "25 15% 88%", "--muted-foreground": "25 15% 45%", "--border": "25 15% 78%", "--accent": "140 20% 40%" },
  modern: { "--background": "220 15% 96%", "--foreground": "220 20% 10%", "--card": "220 10% 93%", "--card-foreground": "220 20% 10%", "--primary": "220 25% 18%", "--primary-foreground": "0 0% 100%", "--secondary": "220 10% 88%", "--secondary-foreground": "220 20% 15%", "--muted": "220 8% 90%", "--muted-foreground": "220 10% 45%", "--border": "220 10% 82%", "--accent": "220 40% 50%" },
  garden: { "--background": "140 20% 96%", "--foreground": "150 30% 12%", "--card": "140 18% 93%", "--card-foreground": "150 30% 12%", "--primary": "150 35% 35%", "--primary-foreground": "0 0% 100%", "--secondary": "140 15% 88%", "--secondary-foreground": "150 30% 15%", "--muted": "140 12% 90%", "--muted-foreground": "150 10% 45%", "--border": "140 12% 82%", "--accent": "45 50% 55%" },
  bohemian: { "--background": "15 25% 95%", "--foreground": "10 30% 14%", "--card": "15 20% 91%", "--card-foreground": "10 30% 14%", "--primary": "10 55% 45%", "--primary-foreground": "15 25% 97%", "--secondary": "30 20% 87%", "--secondary-foreground": "10 30% 18%", "--muted": "20 15% 89%", "--muted-foreground": "10 12% 48%", "--border": "20 15% 80%", "--accent": "45 45% 50%" },
  minimal: { "--background": "0 0% 98%", "--foreground": "0 0% 8%", "--card": "0 0% 96%", "--card-foreground": "0 0% 8%", "--primary": "0 0% 12%", "--primary-foreground": "0 0% 98%", "--secondary": "0 0% 92%", "--secondary-foreground": "0 0% 15%", "--muted": "0 0% 94%", "--muted-foreground": "0 0% 45%", "--border": "0 0% 88%", "--accent": "0 0% 30%" },
  tropical: { "--background": "45 50% 96%", "--foreground": "170 40% 10%", "--card": "45 40% 93%", "--card-foreground": "170 40% 10%", "--primary": "170 55% 35%", "--primary-foreground": "45 50% 97%", "--secondary": "45 30% 88%", "--secondary-foreground": "170 40% 15%", "--muted": "45 25% 90%", "--muted-foreground": "170 15% 45%", "--border": "45 25% 82%", "--accent": "35 70% 55%" },
  lavender: { "--background": "270 25% 97%", "--foreground": "270 20% 14%", "--card": "270 20% 94%", "--card-foreground": "270 20% 14%", "--primary": "270 35% 50%", "--primary-foreground": "0 0% 100%", "--secondary": "270 18% 90%", "--secondary-foreground": "270 20% 18%", "--muted": "270 12% 92%", "--muted-foreground": "270 10% 48%", "--border": "270 12% 84%", "--accent": "300 30% 60%" },
  mediterranean: { "--background": "200 30% 96%", "--foreground": "210 35% 12%", "--card": "200 25% 93%", "--card-foreground": "210 35% 12%", "--primary": "210 50% 40%", "--primary-foreground": "0 0% 100%", "--secondary": "40 30% 88%", "--secondary-foreground": "210 35% 15%", "--muted": "200 15% 90%", "--muted-foreground": "210 15% 45%", "--border": "200 15% 82%", "--accent": "40 55% 55%" },
  autumn: { "--background": "30 25% 95%", "--foreground": "15 35% 12%", "--card": "30 20% 91%", "--card-foreground": "15 35% 12%", "--primary": "15 60% 40%", "--primary-foreground": "30 25% 97%", "--secondary": "35 20% 86%", "--secondary-foreground": "15 35% 16%", "--muted": "30 15% 89%", "--muted-foreground": "15 12% 46%", "--border": "30 15% 80%", "--accent": "45 55% 48%" },
  nocturnal: { "--background": "230 25% 12%", "--foreground": "220 15% 90%", "--card": "230 22% 16%", "--card-foreground": "220 15% 90%", "--primary": "45 60% 60%", "--primary-foreground": "230 25% 10%", "--secondary": "230 18% 22%", "--secondary-foreground": "220 15% 85%", "--muted": "230 15% 20%", "--muted-foreground": "220 10% 55%", "--border": "230 15% 25%", "--accent": "45 50% 50%" },
  vintage: { "--background": "35 22% 94%", "--foreground": "25 28% 17%", "--card": "35 18% 90%", "--card-foreground": "25 28% 17%", "--primary": "345 28% 50%", "--primary-foreground": "35 22% 97%", "--secondary": "35 16% 85%", "--secondary-foreground": "25 28% 22%", "--muted": "35 12% 88%", "--muted-foreground": "25 10% 48%", "--border": "35 14% 78%", "--accent": "30 38% 52%" },
  coastal: { "--background": "200 18% 97%", "--foreground": "210 38% 13%", "--card": "200 14% 93%", "--card-foreground": "210 38% 13%", "--primary": "210 52% 36%", "--primary-foreground": "0 0% 100%", "--secondary": "40 28% 89%", "--secondary-foreground": "210 38% 16%", "--muted": "200 14% 91%", "--muted-foreground": "210 14% 45%", "--border": "200 14% 82%", "--accent": "38 58% 58%" },
  celestial: { "--background": "240 38% 8%", "--foreground": "220 18% 88%", "--card": "240 32% 12%", "--card-foreground": "220 18% 88%", "--primary": "45 72% 58%", "--primary-foreground": "240 38% 8%", "--secondary": "240 25% 18%", "--secondary-foreground": "220 18% 82%", "--muted": "240 20% 16%", "--muted-foreground": "220 12% 52%", "--border": "240 22% 22%", "--accent": "45 55% 42%" },
  spring: { "--background": "345 28% 97%", "--foreground": "330 22% 15%", "--card": "345 22% 94%", "--card-foreground": "330 22% 15%", "--primary": "345 52% 62%", "--primary-foreground": "0 0% 100%", "--secondary": "345 16% 90%", "--secondary-foreground": "330 22% 18%", "--muted": "345 12% 92%", "--muted-foreground": "330 10% 48%", "--border": "345 14% 84%", "--accent": "120 28% 52%" },
  forest: { "--background": "130 18% 92%", "--foreground": "140 38% 9%", "--card": "130 14% 88%", "--card-foreground": "140 38% 9%", "--primary": "140 42% 26%", "--primary-foreground": "130 18% 95%", "--secondary": "130 12% 83%", "--secondary-foreground": "140 38% 13%", "--muted": "130 10% 86%", "--muted-foreground": "140 10% 44%", "--border": "130 12% 76%", "--accent": "30 52% 44%" },
  sunset: { "--background": "28 38% 96%", "--foreground": "15 32% 13%", "--card": "28 30% 92%", "--card-foreground": "15 32% 13%", "--primary": "15 68% 50%", "--primary-foreground": "28 38% 97%", "--secondary": "30 24% 87%", "--secondary-foreground": "15 32% 18%", "--muted": "28 18% 90%", "--muted-foreground": "15 12% 46%", "--border": "28 18% 80%", "--accent": "45 68% 50%" },
};
...
const WeddingPage = () => {
  ...
  // ── FIX: esperar a que authLoading sea false antes de llamar a la RPC ──
  useEffect(() => {
    ...
    const fetchWedding = async () => {
      ...
      if (row) {
        setWedding(row as WeddingData);
        setLoading(false);
        return;
      }
      // Fallback — si el usuario está autenticado, intentar acceso directo por user_id
      if (user) {
        const { data: directData } = await supabase
          ...
          .eq("user_id", user.id)
          .single();
        setWedding(directData as WeddingData | null);
      }
      setLoading(false);
    };
    fetchWedding();
        ...
        {isPreview && (
          <section className="py-16 bg-amber-50 border-t border-amber-200 text-center px-4">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-amber-700 font-light text-sm mb-6">Publícala para que tus invitados puedan verla. Desde 30€, pago único, sin suscripciones y con 30 días de garantía.</p>
